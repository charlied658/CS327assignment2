    ...
    while(!exit){
      try{
        if (type == 0){
          ...
          currentSeg = (Segment) Server.input.readObject();
          //SYN 0, SYNACK 1, FIN 2, FINACK 3, DATA 4, DATAACK 5
          if (currentSeg.type == 0){
            ...
            Server.output.writeObject(theSynack);
            ...
            Segment theFinack = new Segment(3);
            Server.output.writeObject(theFinack);
            ...
            stop();
            Thread.currentThread().interrupt();
            //System.out.println("Exit after FINACK");
          }//end else if
